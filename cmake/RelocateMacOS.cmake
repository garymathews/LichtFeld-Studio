...
set(_lfs_install_root "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}")
file(GLOB_RECURSE _lfs_images
    "${_lfs_install_root}/lib/*.dylib"
    "${_lfs_install_root}/lib/*.so")
list(APPEND _lfs_images "${_lfs_install_root}/bin/LichtFeld-Studio"
    "${_lfs_install_root}/bin/python3")
foreach(_image IN LISTS _lfs_images)
    ...
    file(RELATIVE_PATH _lib_path "${_image_dir}" "${_lfs_install_root}/lib")
